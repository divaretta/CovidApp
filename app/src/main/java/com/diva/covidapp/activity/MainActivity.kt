package com.diva.covidapp.activity

import android.content.Intent
import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import android.widget.Toast
import com.diva.covidapp.R
import com.diva.covidapp.api.RetrofitClient
...
class MainActivity : AppCompatActivity() {
    ...
    private fun showIndonesia() {
        RetrofitClient.instance.getIndonesia().enqueue(object :
            ...
            override fun onResponse(call: Call<ArrayList<IndonesiaResponse>>,
